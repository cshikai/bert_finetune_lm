...
class BERTModel(pl.LightningModule):
    def __init__(self, use_uncased:bool, task:str, lr:float, num_training_steps, num_warmup_steps, batch_size: int, seq_length: int, distributed: bool, model_startpt:str = None):
        super().__init__()
